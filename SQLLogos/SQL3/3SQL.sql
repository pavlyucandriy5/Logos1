...
CREATE TABLE Book (
	...
	`Ціна €` DECIMAL(10,2) NOT NULL DEFAULT '1.0',
    primary key(id)
...
','2019-10-01','Thriller','0141036141','336','George','Orwell','georgvl2@gmail.com',46,'1949-06-25', 'Prometheus Award','18.14' );
...
','2019-11-03','Thriller','0141036133','112','George','Orwell','georgvl1@gmail.com',46,'1949-06-25', 'Prometheus Award','4.79');
...
','2012-11-08','Thriller','1780221355','480','Gillian','Flynn','FlyGlln@gmail.com',48,'1971-02-24', 'Hollywood Film Awards, Alliance of Women Film Journalists Awards, Edgar Award','18.48');
...
','2012-04-05','Thriller','0099560437','384','Ernest','Cline','EClin213ofcl@gmail.com',47,'1972-03-29', DEFAULT, '21.79');
...
",'2020-02-01','Romance','1529018463','544','Margaret','Dickinson','Mgddw@gmail.com',77,'1943-02-11', DEFAULT,'9.93');
...
",'2015-01-01','Crime','0007119313','240','Agatha','Christie','AghataCristie@gmail.com',77,'1890-09-15', "Edgar Award, Anthony Award",'5.58');
...
",'2013-06-26','Crime','0007527519','288','Agatha','Christie','AghataCristie2@gmail.com',77,'1890-09-15', "Edgar Award, Anthony Award", '7.82');
...
",'2011-08-08','Crime','0007284187','736','Agatha','Christie','AghataCristie3@gmail.com',77,'1890-09-15', "Edgar Award, Anthony Award",'12.10');
...
",'2015-10-19','Drama','0349139636','880','Donna','Tartt','Donnatr1941@gmail.com',56,'1963-12-23', "WH Smith Literary Award, Orange Prize for Fiction shortlist, National Book Critics Circle Award",'12.83');
...
at last?
",'2015-04-02','Picture Books','1407154982','24','Aaron','Blabey','aarnyn651@gmail.com',46,'1974-01-01', "National Literacy Ambassador, INDIE books award for Best Children's Book", '6.07');
...
",'2012-10-04','Picture Books','1406338532','40','Jon','Klassen','johnklassen1981@gmail.com',38,'1981-11-29', "Irma Black Award, Caldecott Medal",'6.54');
...
",'2011-01-10','Picture Books','0141385111','48','Eric','Carle','ericarle23@gmail.com',90,'1981-06-25', "Hans Christian Andersen Award, Japan Picture Book Award", '7.07');
...
",'2011-02-17','Crime','0099556758','144','James','Patterson','patternson@gmail.com',72,'1947-03-22', "Edgar Award, the International Thriller of the Year award",'3.58');
...
",'2009-10-15','Fantasy','0575089911','672','Brandon','Sanderson','Sunder@gmail.com',44,'1975-12-19', "Hugo Award, Legend Award",'11.36');
...
",'2016-11-21','Fantasy','1473217709','608','Brandon','Sanderson','Sunder2@gmail.com',44,'1975-12-19', "Hugo Award, Legend Award", '11.90');
...
",'2017-12-15','Fantasy','1785031058','464','Katherine','Arden','KatArden@gmail.com',33,'1987-12-19', DEFAULT,'10.35');
...
",'2000-04-10','Horror','0375703764','709','Mark','Danielewski','MarkDani@gmail.com',53,'1966-03-05', "National Book Award",'17.72');
...
",'2015-05-27','Saga','1609450787','336','Elena','Ferrante','Ferrara@gmail.com',77,'1943-03-05',DEFAULT,'13.35');
...
",'2010-01-26','Saga','0375714367','688','Abraham','Verghese','Abrahamvns@gmail.com',64,'1955-05-05',"Heinz Award, Lambda Literary Award", '10.68');
...
",'2007-09-01','Saga','0451166892','992','Ken','Follett','KenKen1@gmail.com',70,'1949-06-05',"Edgar Award, Commander of the Order of the British Empire", '9.34');
...
",'2019-10-01','Historical','1785769049','448','Heather','Morris','morryHeter@gmail.com',33,'1987-02-01',DEFAULT,'13.70');
...
",'2007-03-03','Adventure','0345391802','224','Douglas','Adams','AdamsCompannyOfcl@gmail.com',49,'2001-05-11',"Hugo Award",'6.29');
...
",'2009-03-01','Fantasy','000647988X','864','George','Raymond','GeorgRRMartin@gmail.com',71,'1948-09-20',"Hugo Award, Nebula Award",'11.95');
...
",'2019-09-05','Romance','1510107037','544','Leigh','Bardugo','LeighBargdo@gmail.com',44,'1975-04-06',"Romantic Times Book Award",'14.62');
...
",'2011-06-29','Military fiction','0099470462','544','Joseph','Heller','authoroflith@gmail.com',76,'1923-05-01',DEFAULT,'6.78');
